...
cuisine: Mexican
category: base
tags: [beans, side, base, mexican, slow-cooker, batch-prep, vegetarian]
base_servings: 9
ingredients:
  - { item: pinto beans, qty: 1, unit: lb, prep: dry, primary: true, section: pantry }
  - { item: onion, qty: 1, unit: count, prep: medium, diced, section: produce }
  - { item: jalapeno, qty: 1, unit: count, prep: medium, seeded and diced, section: produce }
  - { item: garlic, qty: 2, unit: count, prep: minced, section: produce }
  - { item: cumin, qty: 1, unit: tsp, scale: false, section: pantry }
  - { item: chili powder, qty: 0.5, unit: tbsp, scale: false, section: pantry }
  - { item: black pepper, qty: 0.25, unit: tsp, prep: cracked, scale: false, section: pantry }
  - { item: water, qty: 6, unit: cup, section: pantry }
