...
ingredients:
  ...
  - { item: mini peppers, qty: 8, unit: oz, prep: sliced, section: produce }
  - { item: olive oil, qty: 1, unit: tbsp, scale: false, section: pantry }
  - { item: cumin, qty: 1, unit: tbsp, prep: ground, section: pantry }
  ...
  - { item: black beans, qty: 15, unit: oz, prep: no-salt, drained and rinsed, section: pantry }
  - { item: ranch style beans, qty: 15, unit: oz, prep: undrained, section: pantry }
  - { item: baby spinach, qty: 3, unit: oz, section: produce }
