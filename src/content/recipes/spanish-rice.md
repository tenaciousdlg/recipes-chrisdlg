...
ingredients:
  ...
  - { item: roma tomato, qty: 3, unit: count, prep: quartered, section: produce }
  - { item: yellow onion, qty: 0.5, unit: count, prep: roughly chopped, section: produce }
  - { item: garlic, qty: 4, unit: count, section: produce }
  - { item: serrano pepper, qty: 1, unit: count, prep: seeds removed for mild, section: produce }
  - { item: knorr caldo de tomate, qty: 1.5, unit: tsp, prep: dry, scale: false, section: pantry }
  - { item: maggi caldo de pollo, qty: 1, unit: tsp, prep: dry, scale: false, section: pantry }
  - { item: cumin, qty: 1, unit: tsp, scale: false, section: pantry }
  - { item: chili powder, qty: 0.5, unit: tsp, scale: false, section: pantry }
  - { item: water, qty: 3.5, unit: cup, prep: or low-sodium chicken broth, section: pantry }
