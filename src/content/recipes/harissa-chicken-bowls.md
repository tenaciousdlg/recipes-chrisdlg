...
tags: [bowl, braise, batch-prep]
base_servings: 6
ingredients:
  - { item: chicken thigh, qty: 2, unit: lb, prep: boneless skinless, primary: true, section: meat }
  - { item: harissa paste, qty: 3, unit: tbsp, prep: Mina, section: pantry }
  - { item: garlic, qty: 4, unit: count, prep: minced, section: produce }
  - { item: ginger, qty: 1, unit: tsp, prep: grated, section: produce }
  - { item: lemon, qty: 1, unit: count, prep: juiced, section: produce }
  ...
  - { item: greek yogurt, qty: 1, unit: cup, group: sauce, section: dairy }
  - { item: lime, qty: 1, unit: count, prep: juiced, group: sauce, section: produce }
  - { item: garlic, qty: 1, unit: count, prep: minced, group: sauce, scale: false, section: produce }
  - { item: red onion, qty: 1, unit: count, prep: thinly sliced, group: pickle, section: produce }
  - { item: vinegar, qty: 0.5, unit: cup, prep: white/ACV/rice, group: pickle, section: pantry }
